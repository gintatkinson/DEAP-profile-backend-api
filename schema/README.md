...
4. **Toolchain & Downstream Integration**: Feeds downstream synthesis including MATLAB / Simulink / Stateflow model generation, control law synthesis, and DO-178C C/SPARK Ada code generation.
